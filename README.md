...
Basicaly, any class of set A will extends the Bridge and implement the methods of the bridge, in this case, only the Build. And any bridge, in this case, accepts any number of resource, which are going to be a interface of the implementators. So, when you instanciate a bridge, you just call the resource in the constructor.
