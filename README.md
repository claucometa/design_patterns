...
## StateMachine
State machine is suitable when you need to choose the correct behavior of an object when someone interacts with it and the behavior can change depending on the action taken and the response taken to the action.
