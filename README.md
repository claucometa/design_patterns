...
The adapter code is self explanatory. Usually, it's a class that hides the diferent way of operation of another class to simplify / obey the protocol / interface of the client (or a lot of clients).
